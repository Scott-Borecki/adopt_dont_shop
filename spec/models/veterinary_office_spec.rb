...
RSpec.describe VeterinaryOffice, type: :model do
  ...
  let!(:not_on_call_vet) do
    vet_office_1.veterinarians.create(
      name: 'Sam',
      review_rating: 10,
      on_call: false
    )
  ...
  let!(:vet_3) do
    vet_office_2.veterinarians.create(
      name: 'Sarah',
      review_rating: 9,
      on_call: true
    )
  ...
  #                                           max_patient_capacity: 20)
  #
  #   @not_on_call_vet = Veterinarian.create(name: 'Sam', review_rating: 10,
  #                                          on_call: false,
  ...
  describe 'instance methods' do
    describe '#vet_count' do
      it 'returns the number of veterinarians associated with the given '\
         'office' do
